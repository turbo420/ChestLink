...
public class Metric {
	...
	static {
		...
		if (System.getProperty("bstats.relocatecheck") == null
			...
			if (Metric.class.getPackage().getName().equals(defaultPackage)
					|| Metric.class.getPackage().getName().equals(examplePackage)) {
	 ...
	 */
	public Metric(JavaPlugin plugin) {
		if (plugin == null) {
		...
		if (config.getBoolean("enabled", true)) {
			...
			Bukkit.getServicesManager().register(Metric.class, this, plugin, ServicePriority.Normal);
			if (!found) {
				// We are the first!
				startSubmitting();
			}
